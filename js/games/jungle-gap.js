...
function tacticalMapSVG(sc,vm){
  ...
  svg+='</g>';
  const objectiveLabels={dragon:'DRAG',baron:'BARON',herald:'ARAUTO',grubs:'VAST',scuttleTop:'ARONG.',scuttleBot:'ARONG.',mark:'MARCA'};
  ...
  for(const [id,o] of Object.entries(vm.objectives))if(o.state==='UP'||o.state==='SPAWNING'){
    ...
    svg+='<g data-objective="'+esc(id)+'" data-state="'+o.state+'"><title>'+(id==='grubs'?'Vastilarvas':objectiveLabels[id])+'</title>';
